...
from model import PreActResNet18,Net_basic,SimpleDLA
...
X = torch.rand((N, 1, 28, 28), requires_grad=True, device='cuda')
X.data *= 255.
F = Fusion_net()
F = F.cuda()
criterion = torch.nn.CrossEntropyLoss()
tripleloss = torch.nn.TripletMarginLoss(margin=0)
